...
stylescsv = r'/content/myntrak2/myntra_data_cnn/myntradataset/styles.csv'
...
add_startoffile=['/content/dress_skirts/myntra_additional_dataset_dresses',
                 '/content/dress_skirts/myntra_additional_dataset_skirts']
#type of files .jpg, .png, .jfif, etc                 
add_typeoffile=['.jfif',
                 '.jfif']
#For the folder where the images should be moved to
add_startofdestfold=['/content/myntrak2/myntra_data_cnn/data/train/Dresses',
                 '/content/myntrak2/myntra_data_cnn/data/train/Skirts']
